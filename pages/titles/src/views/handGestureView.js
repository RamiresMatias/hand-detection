export default class HandGestureView {
  ...
  constructor({ fingerLookupIndexes, styler }) {
    ...
    // Carrega os estilos assíncronamente (evitar travar a tela enquanto carrega)
    setTimeout(() => {
  ...
  #drawFingersAndHoverElements(keypoints) {
    ...
    for(const finger of fingers) {
      // Retorna os keypoints de cada dedo
  ...
  // Método que retorna as coordenadas do elemento ao qual está posicionado os gestos
  clickOnElement(x, y) {
